...
class EchelleSpectrum(object):
    ...
    @classmethod
    def from_fits_url(cls, url, cache=True):
        """
        Load echelle spectrum from FITS file, download file from ``url``.

        Parameters
        ----------
        url : str
            URL of the spectrum to download
        cache : bool (optional)
            Cache the spectrum locally.
        """
